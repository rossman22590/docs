...
<Steps>
  <Step title="Select Model Type" icon="list-ul">
  ...
  <Step title="Enable Turbo (Optional)" icon="toggle-on">
...
<CardGroup cols={2}>
  ...
  <Card title="Multiple Views (Multiview)" icon="object-group">
...
<AccordionGroup>
  ...
  <Accordion title="Multiview Generation Issues" icon="viewfinder">
