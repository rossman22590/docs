...
<Steps>
  ...
  <Step title="Adjust the 'Become Strength' Slider" icon="sliders">
  ...
  <Step title="Transform and Download" icon="download">
...
<CardGroup cols={1}>
  ...
  <Card title="Fine-Tune with 'Become Strength'" icon="gears">
