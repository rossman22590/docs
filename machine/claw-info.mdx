...
<CardGroup cols={2}>
  <Card icon="paper-plane" title="Machine built-in Telegram">
  ...
  <Card icon="server" title="Gateway (OpenClaw) when using Telegram">
...
<CardGroup cols={2}>
  <Card icon="check-shield" title="Machine built-in Telegram">
  ...
  <Card icon="code" title="Gateway (OpenClaw)">
...
<CardGroup cols={2}>
  <Card icon="check" title="What you get">
  ...
  <Card icon="settings" title="Where to set up">
...
<CardGroup cols={2}>
  <Card icon="server" title="What you get">
  ...
  <Card icon="info" title="What’s different from built-in">
...
<CardGroup cols={2}>
  <Card icon="paper-plane" title="Built-in Telegram">
  ...
  <Card icon="server" title="Messaging gateway (OpenClaw)">
